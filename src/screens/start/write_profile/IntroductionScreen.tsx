    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{marginTop: 30}}>
        <View style={styles.section}>
          <Text style={[styles.boldText, {fontSize: 16, color: '#FF281D', letterSpacing: -0.3}]}>
          AI 어시스턴스 쿠피를 소개합니다!</Text>
        </View>
        ...
        <View style={[styles.section, { marginTop: 24, }]}>
          <Text style={[styles.boldTextBB, { letterSpacing: -0.3 }]}>👇 쿠피가 회원님의 프로필 글을 작성해 봤어요.</Text>
        </View>
